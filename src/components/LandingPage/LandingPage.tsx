    ...
    <div className="bg-white flex flex-row justify-center w-full">
      <div className="bg-white overflow-hidden w-[1440px] h-[4376px] relative">
            ...
            <div className="flex items-center gap-[104px] px-36 py-24 relative self-stretch w-full flex-[0_0_auto] bg-neutralsilver">
              <div className="flex flex-col items-start gap-8 relative flex-1 grow">
                <div className="flex flex-col items-start gap-4 relative self-stretch w-full flex-[0_0_auto]">
                  <p className="relative self-stretch mt-[-1.00px] font-heading-headline-1 font-[number:var(--heading-headline-1-font-weight)] text-neutraldgrey text-[length:var(--heading-headline-1-font-size)] tracking-[var(--heading-headline-1-letter-spacing)] leading-[var(--heading-headline-1-line-height)] [font-style:var(--heading-headline-1-font-style)]">
                  ...
                  <div className="flex flex-col w-[267px] items-center gap-4 relative flex-[0_0_auto] ml-[-16.00px] mr-[-16.00px]">
                    <div className="relative w-[65px] h-14">
                      <div className="relative w-[65px] h-14">
                        ...
                        <img className="absolute w-12 h-12 top-0 left-0" alt="Icon" src="icon-3.svg" />
                      </div>
                    </div>
                ...
                <div className="flex flex-col w-[299px] items-center gap-2 px-8 py-6 relative bg-neutralwhite rounded-lg shadow-[0px_2px_4px_#abbed133]">
                  <div className="flex flex-col w-[267px] items-center gap-4 relative flex-[0_0_auto] ml-[-16.00px] mr-[-16.00px]">
                    <div className="relative w-[65px] h-14">
                      <div className="relative w-[65px] h-14">
                        <div className="absolute w-[50px] h-[49px] top-[7px] left-[15px] bg-tintt-5 rounded-[18px_5px_10px_5px] -rotate-180" />
                        <img className="absolute w-12 h-12 top-0 left-0" alt="Icon" src="icon-2.svg" />
                      </div>
                    </div>
                    <div className="relative self-stretch font-heading-headline-3 font-[number:var(--heading-headline-3-font-weight)] text-neutraldgrey text-[length:var(--heading-headline-3-font-size)] text-center tracking-[var(--heading-headline-3-letter-spacing)] leading-[var(--heading-headline-3-line-height)] [font-style:var(--heading-headline-3-font-style)]">
                ...
                <div className="flex flex-col w-[299px] items-center gap-2 px-8 py-6 relative bg-neutralwhite rounded-lg shadow-[0px_2px_4px_#abbed133]">
                  <div className="flex flex-col w-[267px] items-center gap-4 relative flex-[0_0_auto] ml-[-16.00px] mr-[-16.00px]">
                    <div className="relative w-[65px] h-14">
                      <div className="relative w-[65px] h-14">
                        <div className="absolute w-[50px] h-[49px] top-[7px] left-[15px] bg-tintt-5 rounded-[18px_5px_10px_5px] -rotate-180" />
                        <img className="absolute w-12 h-12 top-0 left-0" alt="Icon" src="icon-4.svg" />
                      </div>
                    </div>
        ...
        <div className="inline-flex flex-col items-start justify-center gap-12 absolute top-[1411px] left-px">
          <div className="inline-flex items-start relative flex-[0_0_auto] overflow-x-scroll">
            <div className="flex w-[1440px] items-center justify-between px-36 py-0 relative">
              <img className="relative w-[442px] h-[433px]" alt="Frame" src="Frame 35.svg" />
          ...
          <div className="flex w-[1440px] items-center justify-between px-36 py-16 relative flex-[0_0_auto] bg-neutralsilver">
            <div className="flex flex-col w-[540px] items-start gap-2 relative">
              <div className="inline-flex flex-col items-start gap-2 relative flex-[0_0_auto]">
                <p className="w-[408px] text-neutraldgrey relative mt-[-1.00px] font-heading-headline-2 font-[number:var(--heading-headline-2-font-weight)] text-[length:var(--heading-headline-2-font-size)] tracking-[var(--heading-headline-2-letter-spacing)] leading-[var(--heading-headline-2-line-height)] [font-style:var(--heading-headline-2-font-style)]">
            ...
            <div className="inline-flex flex-col items-center gap-10 relative flex-[0_0_auto]">
              <div className="inline-flex items-center gap-[30px] relative flex-[0_0_auto]">
                <div className="inline-flex items-center gap-4 relative flex-[0_0_auto]">
                  <img className="relative w-12 h-12" alt="Icon" src="icon-7.svg" />
                  <div className="inline-flex flex-col items-start relative flex-[0_0_auto]">
                    ...
                    <div className="w-[191px] text-neutralgrey relative font-body-regular-body-2 font-[number:var(--body-regular-body-2-font-weight)] text-[length:var(--body-regular-body-2-font-size)] tracking-[var(--body-regular-body-2-letter-spacing)] leading-[var(--body-regular-body-2-line-height)] [font-style:var(--body-regular-body-2-font-style)]">
                      Members
                    </div>
                  </div>
                </div>
              ...
              <div className="inline-flex items-center gap-[30px] relative flex-[0_0_auto]">
                <div className="inline-flex items-center gap-4 relative flex-[0_0_auto]">
                  <img className="relative w-12 h-12" alt="Icon" src="icon-5.svg" />
                  <div className="inline-flex flex-col items-start relative flex-[0_0_auto]">
                    <div className="relative w-[191px] mt-[-1.00px] font-heading-headline-3 font-[number:var(--heading-headline-3-font-weight)] text-neutraldgrey text-[length:var(--heading-headline-3-font-size)] tracking-[var(--heading-headline-3-letter-spacing)] leading-[var(--heading-headline-3-line-height)] [font-style:var(--heading-headline-3-font-style)]">
                      828,867
                    </div>
                  ...
                  <div className="absolute w-[158px] h-[345px] top-[51px] left-[163px]">
                    <div className="relative w-[156px] h-[345px]">
                      <img
                        ...
                        src="vector-9.svg"
                      />
                      {/* <img className="absolute w-20 h-6 top-[236px] left-[35px]" alt="Vector" src="vector-11.svg" /> */}
                      {/* <div className="absolute w-[99px] top-[242px] left-[57px] [font-family:'Montserrat-Regular',Helvetica] font-normal text-[#e8e8e3] text-[8.1px] tracking-[0] leading-[normal]">
                        SING UP
                      </div> */}
                      {/* <img
                      ...
                      <img
                        ...
                        src="vector-12.svg"
                      /> */}
                      {/* <img className="absolute w-[27px] h-[5px] top-32 left-[25px]" alt="Vector" src="vector-4.svg" />
                      <img className="absolute w-[27px] h-[5px] top-32 left-[25px]" alt="Vector" src="vector-4.svg" /> */}
                      {/* <img className="absolute w-[107px] h-[18px] top-[140px] left-6" alt="Vector" src="vector-8.svg" /> */}
                      {/* <img
                      ...
                      {/* <img
                        ...
                        src="vector-4.svg"
                      /> */}
                      {/* <img className="absolute w-[107px] h-[18px] top-[186px] left-6" alt="Vector" src="vector-5.svg" /> */}
          ...
          <div className="flex w-[1440px] items-center gap-[78px] px-36 py-8 relative flex-[0_0_auto] bg-neutralsilver">
            ...
            <div className="flex flex-col items-start gap-8 relative flex-1 grow">
              ...
              <div className="flex items-center gap-8 relative self-stretch w-full flex-[0_0_auto]">
                <img className="relative flex-[0_0_auto]" alt="Frame" src="Frame 10.svg" />
                <div className="flex items-center gap-2 p-2 relative flex-1 grow">
                  ...
                  <img className="mr-[-13.00px] relative w-6 h-6" alt="Element arrows directions" src="right.svg" />
                </div>
              </div>
            </div>
          </div>
          <div className="inline-flex gap-4 flex-col items-center relative flex-[0_0_auto]">
            ...
            <div className="flex w-[1440px] items-center justify-between px-36 py-0 relative flex-[0_0_auto]">
              <div className="inline-flex flex-col items-center relative flex-[0_0_auto]">
                <img className="relative w-[368px] h-[286px] object-cover" alt="Image" src="image-18.png" />
                <div className="inline-flex flex-col items-center gap-4 p-4 relative flex-[0_0_auto] -mt-24 bg-neutralsilver rounded-lg shadow-shadow-8px">
                  ...
                  <div className="flex items-center justify-center gap-2 p-2 relative self-stretch w-full flex-[0_0_auto]">
                    ...
                    <img className="relative w-6 h-6" alt="Element arrows directions" src="right.svg" />
                  </div>
                </div>
              </div>
              <div className="inline-flex flex-col items-center relative flex-[0_0_auto]">
                <img className="relative w-[368px] h-[286px]" alt="Image" src="image-19.png" />
                <div className="inline-flex flex-col items-center gap-4 p-4 relative flex-[0_0_auto] -mt-24 bg-neutralsilver rounded-lg shadow-shadow-8px">
                  <p className="relative w-[285px] mt-[-1.00px] font-heading-headline-4 font-[number:var(--heading-headline-4-font-weight)] text-neutralgrey text-[length:var(--heading-headline-4-font-size)] text-center tracking-[var(--heading-headline-4-letter-spacing)] leading-[var(--heading-headline-4-line-height)] [font-style:var(--heading-headline-4-font-style)]">
              ...
              <div className="inline-flex flex-col items-center relative flex-[0_0_auto]">
                <img className="relative w-[368px] h-[286px] object-cover" alt="Image" src="image-20.png" />
                <div className="inline-flex flex-col items-center gap-4 p-4 relative flex-[0_0_auto] -mt-24 bg-neutralsilver rounded-lg shadow-shadow-8px">
                  <p className="relative w-[285px] mt-[-1.00px] font-heading-headline-4 font-[number:var(--heading-headline-4-font-weight)] text-neutralgrey text-[length:var(--heading-headline-4-font-size)] text-center tracking-[var(--heading-headline-4-letter-spacing)] leading-[var(--heading-headline-4-line-height)] [font-style:var(--heading-headline-4-font-style)]">
        ...
        <footer className="inline-flex flex-col items-start absolute top-[3748px] left-0 bg-transparent">
          ...
          <div className="inline-flex items-start gap-[125px] px-[165px] py-16 relative flex-[0_0_auto] bg-neutralblack">
            <div className="inline-flex flex-col items-start gap-10 relative flex-[0_0_auto] overflow-hidden">
              ...
              <div className="inline-flex items-start gap-4 relative flex-[0_0_auto]">
                <img className="relative w-8 h-8" alt="Social icons" src="social-icons-4.svg" />
                <img className="relative w-8 h-8" alt="Social icons" src="social-icons-3.svg" />
                <img className="relative w-8 h-8" alt="Social icons" src="social-icons-2.svg" />
                <img className="relative w-8 h-8" alt="Social icons" src="social-icons.svg" />
              </div>
            </div>
              ...
              <div className="inline-flex flex-col items-start gap-6 relative flex-[0_0_auto] overflow-hidden">
                ...
                <div className="relative w-[257px] h-10 mr-[-2.00px]">
                  <div className="relative w-[255px] h-10 rounded-lg">
                    ...
                    <img
                      className="absolute w-[18px] h-[18px] top-[11px] left-[225px]"
          ...
          <div className="absolute w-[588px] h-6 top-[30px] left-[426px]">
            <div className="inline-flex items-center justify-center gap-[50px] relative">
              <div className="inline-flex items-center gap-2.5 relative flex-[0_0_auto]">
                <div className="w-fit mt-[-1.00px] text-text-gray-900 whitespace-nowrap relative font-body-medium-body-2 font-[number:var(--body-medium-body-2-font-weight)] text-[length:var(--body-medium-body-2-font-size)] tracking-[var(--body-medium-body-2-letter-spacing)] leading-[var(--body-medium-body-2-line-height)] [font-style:var(--body-medium-body-2-font-style)]">
                  Home
                </div>
              </div>
              <div className="inline-flex items-center gap-2.5 relative flex-[0_0_auto]">
                <div className="w-fit mt-[-1.00px] text-text-gray-900 whitespace-nowrap relative font-body-regular-body-2 font-[number:var(--body-regular-body-2-font-weight)] text-[length:var(--body-regular-body-2-font-size)] tracking-[var(--body-regular-body-2-letter-spacing)] leading-[var(--body-regular-body-2-line-height)] [font-style:var(--body-regular-body-2-font-style)]">
                  Service
                </div>
              </div>
              <div className="inline-flex items-center gap-2.5 relative flex-[0_0_auto]">
